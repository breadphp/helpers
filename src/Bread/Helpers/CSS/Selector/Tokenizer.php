...
class Tokenizer
{
    ...
    /**
     * Tokenizes a quoted string (i.e.
     * 'A string quoted with \' characters'),
     ...
     *
     * @param string $s
     *            The selector string containing the quoted string.
     * @param integer $pos
     *            The starting position for the quoted string.
     *            
     * @return array
     *
     ...
     *            The selector string.
     * @param integer $pos
     *            The position in $s at which the symbol starts.
     *            
     * @return array
     *
