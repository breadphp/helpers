...
class Selector
{
     ...
     *
     * @param TokenStream $stream
     *            The stream containing the selector.
     *            
     * @return Node\NodeInterface
     *
    ...
    private function parseSelector($stream)
    {
        ...
        while (true) {
            ...
            $result = new Selector\Node\CombinedSelectorNode($result, $combinator, $nextSelector);
        }
    ...
    private function parseSimpleSelector($stream)
    {
        ...
        while (true) {
            ...
            if ('#' == $peek) {
                if ($hasHash) {
                    /*
                     * You can't have two hashes (FIXME: is there some more general rule I'm missing?)
                     */
     ...
     *            The selector object whose attribute
     *            is to be parsed.
     * @param TokenStream $stream
     *            The container token stream.
     *            
