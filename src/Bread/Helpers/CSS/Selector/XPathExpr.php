...
class XPathExpr
{
     ...
     *
     * @param string $prefix
     *            Prefix for the XPath expression.
     * @param string $path
     *            Actual path of the expression.
     * @param string $element
     *            The element in the expression.
     * @param string $condition
     *            A condition for the expression.
     * @param Boolean $starPrefix
     *            Indicates whether to use a star prefix.
     */
    ...
    {
        /*
         * Adds a /* prefix if there is no prefix. This is when you need to keep context's constrained to a single
         * parent.
         */
        if ($this->path) {
            $this->path .= '*/';
     ...
     *            The combiner string.
     * @param XPathExpr $other
     *            The other XPath expression to combine with
     *            this one.
     */
    public function join($combiner, $other)
    {
        ...
        /*
         * We don't need a star prefix if we are joining to this other prefix; so we'll get rid of it
         */
     ...
     *
     * @param mixed $s
     *            Can either be a Node\ElementNode or a string.
     *            
     * @return string
     */
