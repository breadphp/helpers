...
class Node implements Interfaces\Node
{
    ...
    public function __construct(Document $document, $name, $value = null, $attributes = array(), $namespace = null)
    {
        $this->document = $document;
        if (is_string($name)) {
            $this->nodes = $this->document->create($name, $value, $attributes, $namespace)->nodes;
    ...
    {
        return $this->document->save($this->nodes[$this->position]);
    }
