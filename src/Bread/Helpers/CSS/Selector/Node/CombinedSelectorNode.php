...
class CombinedSelectorNode implements Interfaces\Node
{
     ...
     *            The XPath expression for this object
     * @param NodeInterface $sub
     *            The NodeInterface object to add
     *            
     ...
     *            The parent XPath expression
     * @param NodeInterface $sub
     *            The indirect adjacent NodeInterface object
     *            
     * @return XPathExpr An XPath instance
     */
